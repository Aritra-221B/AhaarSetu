...
export default function MultiDashboardTabs() {
  ...
  return (
    <>
      {/* Tabs container */}
      <div className="w-[95%] max-w-8xl mx-auto mt-10 bg-white shadow-2xl rounded-2xl p-8 min-h-[700px]">
        {/* Tabs */}
        ...
        <div className="p-4 md:p-6">
          ...
          {activeTab === "dashboard1" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg border min-h-[400px]">
          ...
          {activeTab === "dashboard2" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border min-h-[400px]">
                <h2 className="text-xl font-bold mb-6">MRL Compliance Indicator</h2>
                <div className="flex items-center justify-center h-[300px] text-gray-400">
          ...
          {activeTab === "dashboard3" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border min-h-[400px]">
                <h2 className="text-xl font-bold mb-6">Antimicrobial Cost vs Doses</h2>
                <div className="flex items-center justify-center h-[300px] text-gray-400">
