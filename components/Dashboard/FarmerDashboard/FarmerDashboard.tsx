		...
		<div className="min-h-screen bg-green-50 rounded-2xl p-8">
			...
			<div className="bg-green-200 rounded-xl shadow-lg border border-gray-200 mb-8">
				<div className="border-b border-gray-200 px-4 sm:px-6 lg:px-8">
					<nav className="-mb-px flex flex-wrap justify-center sm:justify-start space-x-0 sm:space-x-8" aria-label="Tabs">
						{
							(
								[
								...
								<button
									...
									className={`py-4 px-3 sm:px-4 text-base font-medium border-b-2 transition-colors duration-200 ease-in-out
