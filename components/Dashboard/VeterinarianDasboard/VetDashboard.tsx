...
export const VetDashboard: React.FC = () => {
  const cards = [
    { title: "Registered Farms", value: 12, icon: Users, color: "text-green-600", bgColor: "bg-green-100" },
    ...
    <div className="min-h-screen bg-green-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-extrabold text-green-800 mb-2">Veterinarian Dashboard</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {cards.map((card, i) => (
            <motion.div
              ...
              className="bg-green-100 rounded-xl shadow-lg border border-gray-200 p-6 flex items-center gap-4 cursor-pointer"
            >
        ...
        <div className="bg-green-200 rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
          <h3 className="text-2xl font-bold text-green-800 mb-4">Veterinarian Features</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <motion.div
              ...
              className="p-6 border border-gray-200 rounded-xl bg-green-50 shadow-sm cursor-pointer"
            >
              <h4 className="font-semibold text-lg text-green-800 mb-2">Farm Monitoring</h4>
            ...
            <motion.div
              ...
              className="p-6 border border-gray-200 rounded-xl bg-green-50 shadow-sm cursor-pointer"
            >
              <h4 className="font-semibold text-lg text-green-800 mb-2">Treatment Prescription</h4>
              <p className="text-base text-green-600">
            ...
            <motion.div
              ...
              className="p-6 border border-gray-200 rounded-xl bg-green-50 shadow-sm cursor-pointer"
            >
              <h4 className="font-semibold text-lg text-green-800 mb-2">Compliance Reports</h4>
              <p className="text-base text-green-600">
