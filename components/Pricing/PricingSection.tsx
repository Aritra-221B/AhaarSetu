  ...
  Intermediate: [
    {
      ...
      discountedPrice: '₹600',
      savePercentage: '25%',
      monthlyPrice: '₹2399 /month', // Note: Data says 2400, not 4800 if it's per session price * sessions. Assuming 2400 is correct.
      formatText: '1:2 Semi-Private Class',
      icon: '🤝',
    ...
    },
    {
      ...
      monthlyPrice: '2999 /month', // Note: Data says 3000.
      formatText: '1:1 Personal Coaching',
      icon: '👤',
      features: ["Deeper Musical Techniques", "Expert Guidance & Support", "Trinity, ABRSM, RSL certified faculties to provide the best education"],
    },
