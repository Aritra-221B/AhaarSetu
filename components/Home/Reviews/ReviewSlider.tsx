...
const ReviewSlider = () => {
  return (
    <div>
        <Swiper effect={"cards"}grabCursor={true} modules={[EffectCards]} className="md:w-[450px] md:h-[350px] w-[80%] h-[300px]"
                            ...
                            <div className="mt-4 ">
                                <div className="flex items-center space-x-2 mb-10">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-900 text-xs sm:text-ba text-bold">{data.course}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
