    ...
    Foundation: [
      {
        ...
        icon: '🟢',
        features: [
          'Introduced to basics of Hindustani Vocal through simple exercises and ragas.',
          'Begin learning sargam, basic notation, and voice control.',
    ...
    Beginner: [
      {
        ...
        icon: '🟢',
        features: [
          'Explore rhythm patterns and melodic flow.',
          'Build singing confidence through Hindustani compositions.',
          'Introduction to alankars for voice development.',
    ...
    EarlyIntermediate: [
      {
        ...
        icon: '🟢',
        features: [
          'Sing longer compositions with better control and expression.',
          'Focus on voice modulation and favorite styles like Khayal or Thumri.',
    ...
    EarlyAdvanced: [
      {
        ...
        icon: '🟠',
        features: [
          'Perform advanced ragas with control and emotion.',
  ...
  return (
    <section className="relative w-full py-24 px-4 sm:px-8 bg-gradient-to-br from-indigo-50 via-white to-purple-100 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <SectionHeading heading="Chordscraft's" subheading="Hindustani Vocal Journey" />
...
export default FullHindustaniPricing;
