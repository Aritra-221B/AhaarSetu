...
import HindustaniTeachers from './HindustaniTeachers';

const HindustaniTeacher = () => {
  return (
      ...
      <div className="max-w-full mx-auto px-3">
        <div className="text-center mb-12">
          <h2 className="text-5xl font-semibold text-gray-800 mb-6">
            🎵 Meet Our <span className="text-teal-600 font-bold">Hindustani Vocal Teachers</span>
          </h2>
        </div>
        ...
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll">
            ...
            {HindustaniTeachers.map((teacher: { name: string; instrument: string; image: string }, index: number) => (
...
export default HindustaniTeacher;
