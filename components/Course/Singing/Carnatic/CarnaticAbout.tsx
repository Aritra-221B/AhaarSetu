      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-9xl mx-auto">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20">
            <div className="text-lg md:text-xl text-gray-200 leading-relaxed space-y-6">
              ...
              <p>
                At <span className="text-purple-300 font-bold">ChordsCraft Institute of Music</span>, our online Carnatic Singing program is designed by expert vocalists to support learners of all ages—whether you're just starting out or aiming to level up your skills.
              </p>
              <p>
                Our curriculum is tailored for both hobby learners and students aiming for certification. Whether you're preparing for <span className="text-pink-300 font-semibold">Trinity or ABRSM</span> exams or simply wish to explore <span className="text-purple-300 font-semibold">Carnatic Vocal forms</span>, our sessions adapt to your needs and pace.
              </p>
              <p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-gray-300">Curated training for all levels — Carnatic Classical, Light Classical, and Bhajans.</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-gray-300">Participate in vocal recitals, concerts, and studio performances.</p>
          </div>
        </div>
        {/* Call to Action */}
