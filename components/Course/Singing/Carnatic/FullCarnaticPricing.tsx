    ...
    Foundation: [
      {
        ...
        icon: '🟢',
        features: [
          'Introduced to basics of Carnatic Vocal through simple exercises and ragas.',
    ...
    Beginner: [
      {
        ...
        features: [
          ...
          'Build singing confidence through Carnatic compositions.',
  ...
  return (
    <section className="relative w-full py-24 px-4 sm:px-8 bg-gradient-to-br from-indigo-50 via-white to-purple-100 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <SectionHeading heading="Chordscraft's" subheading="Carnatic Vocal Journey" />
...
export default FullCarnaticPricing;
