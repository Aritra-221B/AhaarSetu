    ...
    Foundation: [
      {
        ...
        icon: '🟢',
        features: [
          'Introduced to basics of Western Vocal through simple exercises and songs.',
          'Begin learning music notation, basic sight reading, and voice control.',
    ...
    Beginner: [
      {
        ...
        features: [
          ...
          'Build singing confidence through Western compositions.',
          'Introduction to vocal techniques and breathing exercises.',
    ...
    EarlyIntermediate: [
      {
        ...
        icon: '🟢',
        features: [
          'Sing longer pieces with better control and expression.',
          'Focus on voice modulation and favorite styles like Pop or Jazz.',
    ...
    EarlyAdvanced: [
      {
        ...
        icon: '🟠',
        features: [
          'Perform advanced songs with control and emotion.',
  ...
  return (
    <section className="relative w-full py-24 px-4 sm:px-8 bg-gradient-to-br from-indigo-50 via-white to-purple-100 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <SectionHeading heading="Chordscraft's" subheading="Western Vocal Journey" />
...
export default FullWesternPricing;
