    ...
    Foundation: [
      {
        ...
        icon: '🟢',
        features: [
          'Introduced to basics of music and acoustic guitar through simple songs and fun activities.',
    ...
    Beginner: [
      {
        ...
        features: [
          ...
          'Build playing confidence through short two-hand acoustic guitar pieces.',
  ...
  return (
    <section className="relative w-full py-24 px-4 sm:px-8 bg-gradient-to-br from-indigo-50 via-white to-purple-100 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <SectionHeading heading="Chordscraft's" subheading="Acoustic Guitar Journey" />
