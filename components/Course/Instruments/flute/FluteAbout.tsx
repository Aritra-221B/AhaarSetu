        ...
        <div className="max-w-9xl mx-auto">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20">
            <div className="text-lg md:text-xl text-gray-200 leading-relaxed space-y-6">
              ...
              <p>
                At <span className="text-purple-300 font-bold">ChordsCraft Institute of Music</span>, our online Flute program is designed by expert musicians to support learners of all ages—whether you're just starting out or aiming to level up your skills.
              </p>
              <p>
