      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20">
            <div className="text-lg md:text-xl text-gray-200 leading-relaxed space-y-6">
              <p className="text-2xl md:text-3xl font-semibold text-white mb-8">
                Transform Your Dance Journey
              </p>
              <p>
                At <span className="text-purple-300 font-bold">ChordsCraft Institute of Music</span>, our online Classical Dance program is designed by expert dancers to support learners of all ages—whether you're just starting out or aiming to level up your skills.
              </p>
              <p>
                Our curriculum is tailored for both hobby learners and students aiming for certification. Whether you're preparing for <span className="text-pink-300 font-semibold">Trinity or ABRSM</span> exams or simply wish to explore <span className="text-purple-300 font-semibold">Classical Dance forms</span>, our sessions adapt to your needs and pace.
              </p>
              <p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-gray-300">Learn from trained, experienced dancers with real industry and teaching backgrounds.</p>
          </div>
          ...
          {/* Dance Routines & Learning Paths */}
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
            <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-indigo-500 to-fuchsia-500 rounded-full mb-4">
              <Sheet className="w-6 h-6 text-white" />
            </div>
            <h3 className="text-xl font-bold text-white mb-2">Dance Routines & Learning Paths</h3>
            <p className="text-gray-300">Curated routines for all levels — Classical, Contemporary, and Traditional forms.</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-gray-300">Participate in dance recitals, showcases, and studio performances.</p>
          </div>
        </div>
        {/* Call to Action */}
